...
obsInfo = rlNumericSpec([29 1],...
    'LowerLimit',[43 -156 -inf -inf -151 -125 -inf -inf -150 48 ...
    -inf -inf 94 44 -inf -inf -inf -inf -inf -inf -inf -inf -inf ...
    -inf -inf -inf -inf -inf -inf]',...
    'UpperLimit',[113 -96 inf inf -91 -45 inf inf -90 128 inf ...
    inf 154 124 inf inf inf inf inf inf inf inf inf ...
    inf inf inf inf inf inf]');
obsInfo.Name = 'observations';
numObservations = obsInfo.Dimension(1);
actInfo = rlNumericSpec([8 1],'LowerLimit',-50,'UpperLimit',50);
numActions = actInfo.Dimension(1);
env = rlSimulinkEnv('Long_Dog_Simulation','Long_Dog_Simulation/RL Agent' ...
    ,obsInfo,actInfo);
...
statePath = [
    ...
    fullyConnectedLayer(criticLayerSizes(1), 'Name', 'CriticStateFC1', ... 
            'Weights',2/sqrt(numObservations)*(rand(criticLayerSizes(1) ...
            ,numObservations)-0.5), ...
...
actorNetwork = [
    ...
    fullyConnectedLayer(actorLayerSizes(2), 'Name', 'ActorFC2', ... 
            'Weights',2/sqrt(actorLayerSizes(1))*(rand(actorLayerSizes(2) ...
            ,actorLayerSizes(1))-0.5), ... 
